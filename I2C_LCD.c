...
void lcd_init(void) {
	  ...
	  mcp23008_reg_write(LCD_I2C_DEVICE,MCP23008_GPIO,0x00);
	  i2c_stop();
	  mcp23008_reg_write(LCD_I2C_DEVICE,MCP23008_IODIR,0x00);
	  i2c_stop();
	  mcp23008_reg_write(LCD_I2C_DEVICE,MCP23008_INTCON,0b00100000);
	  i2c_stop();
	  mcp23008_reg_write(LCD_I2C_DEVICE,MCP23008_GPIO,0x00);
	  i2c_stop();
...
void lcd_write(uint8_t value) {
	...
	mcp23008_reg_write(LCD_I2C_DEVICE,MCP23008_GPIO,data_out);
	i2c_stop();
	mcp23008_reg_write(LCD_I2C_DEVICE,MCP23008_GPIO,data_out| LCD_E);
	i2c_stop();
	mcp23008_reg_write(LCD_I2C_DEVICE,MCP23008_GPIO,data_out);
	i2c_stop();
...
/*
	...
	i2c_write(data_out); 
	i2c_write(MCP23008_GPIO);               // setup data BEFORE E!   
	i2c_write(data_out | LCD_E);
	i2c_write(MCP23008_GPIO);		// set E to high
...
uint8_t lcd_read(bool mode) {
	...
	mcp23008_reg_write(LCD_I2C_DEVICE,MCP23008_GPIO,lcddata_w);
	i2c_stop();
	mcp23008_reg_write(LCD_I2C_DEVICE,MCP23008_GPIO,lcddata_w | LCD_E);
	//i2c_stop();
	
	lcddata_r = mcp23008_reg_read(LCD_I2C_DEVICE,MCP23008_GPIO);
	i2c_stop();
...
void lcd_light(bool light) {
	...
	mcp23008_reg_write(LCD_I2C_DEVICE,MCP23008_GPIO,data);
	i2c_stop();
}
