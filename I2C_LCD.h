/*****************************************************************************
 ...
 Copyright (C) 2006 Nico Eichelmann and Thomas Eichelmann
			   ...
			   2015 modified for MCP23008 by Buelent Cakir amk-artists@t-online.de
...
//#define LCD_I2C_DEVICE		0x4E	    /** I2C adress is in MCP23008.h
...
*/
/*@{*/
#define LCD_D4_PIN			3	/**< LCD-Pin D4 is connected to P4 on the MCP23008 */
#define LCD_D5_PIN			4	/**< LCD-Pin D5 is connected to P5 on the MCP23008 */
#define LCD_D6_PIN			5	/**< LCD-Pin D6 is connected to P6 on the MCP23008 */
#define LCD_D7_PIN			6	/**< LCD-Pin D7 is connected to P7 on the MCP23008 */
#define LCD_RS_PIN			1	/**< LCD-Pin RS is connected to P0 on the MCP23008 */
#define LCD_RW_PIN			0	/**< LCD-Pin RW is connected to P1 on the MCP23008 */
#define LCD_E_PIN			2	/**< LCD-Pin E is connected to P2 on the MCP23008 */
#define LCD_LIGHT_PIN	    7	/**< LCD backlight is connected to P3 on the MCP23008 */
/*@}*/
...
/**
 \brief Define a user character
 \param chardata pointer to char data in flash
 \param number code of user char (0-7)
 \return none
 */
